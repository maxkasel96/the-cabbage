        ...
        },
        {
          ...
          content: JSON.stringify({
            rules: [
              ...
              "Write reasons in plain player-facing language and do not mention tags, tag matching, inferred tags, tag IDs, tag labels, or metadata.",
              "Do not use phrases like 'supporting tags', 'matched tags', 'inferred tags', or any wording that reveals tag data.",
